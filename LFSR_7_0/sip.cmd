...
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt7 -b 	mt4,mt3,mt2,mt1,poly,diff,sti -t mt8,mt9 -Maxw 2.1 -p 	mt5:mt5_cut,key,mt7,key 0,2.1,0 - mt5_mt7.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt4,mt3,mt2,mt1,poly,diff,sti -t 	mt7,mt8,mt9 -Maxw 2.1 -p mt5:mt5_cut,key,mt6,key 0,2.1,0 - 	mt5_mt6.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt6 -b 	mt3,mt2,mt1,poly,diff,sti -t mt7,mt8,mt9 -k mt5:0.36 -Maxw 2.1 -p 	mt4:mt4_cut,key,mt6,key 0,2.1,0 - mt4_mt6.sip
