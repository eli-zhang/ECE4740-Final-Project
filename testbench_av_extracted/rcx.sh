#!/bin/ksh
# This script was generated Mon May 17 19:53:28 2021 by:
#
...
#	/opt/cadence-designkits/gpdk090_v3.9/assura/rcx -newlvs \
#	/home/hpl23/ECE4740-Final-Project/testbench_av_extracted.xcn \
#	-assura_run_dir /home/hpl23/ECE4740-Final-Project -assura_run_name \
#	testbench_av_extracted -rcxdir \
#	/home/hpl23/ECE4740-Final-Project/testbench_av_extracted \
#	-xy_coordinates c,r -type full -temperature 25.0 -tempdir \
#	/home/hpl23/ECE4740-Final-Project/testbench_av_extracted/rcx_temp \
...
#	/home/hpl23/ECE4740-Final-Project/testbench_av_extracted/extview.tmp \
...
##AGDS_TEXT_LAYERS=
##ARRAY_VIAS_SPACING=
##ASSURA_RUN_DIR=/home/hpl23/ECE4740-Final-Project
##ASSURA_RUN_NAME=testbench_av_extracted
...
##NETS_FILE=/dev/null
##OUTPUT=/home/hpl23/ECE4740-Final-Project/testbench_av_extracted/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/hpl23/ECE4740-Final-Project/testbench_av_extracted
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/hpl23/ECE4740-Final-Project/testbench_av_extracted/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/hpl23/ECE4740-Final-Project/testbench_av_extracted/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/hpl23/ECE4740-Final-Project/testbench_av_extracted
...
export GOALIE2DIR
vdbToRcx /home/hpl23/ECE4740-Final-Project testbench_av_extracted -unit \
	meters -mFactorR -- -V1 -H satfile -r \
	/home/hpl23/ECE4740-Final-Project/testbench_av_extracted.xcn -df2 \
	-xgl
...
geom -V Via6 metal7_conn metal6_conn - Via6,111,i,2
...
flattenLayers -m metal7_conn metal6_conn metal5_conn metal4_conn metal3_conn \
	metal2_conn metal1_conn poly_conn ndiff_conn pdiff_conn nwell_conn \
	psubstrate Via6 Via5 Via4 Via3 via2_out_capInd Via1 Metal1_v Metal1_p \
	cont_poly cont_pdiff cont_ndiff ptap_pdiff_conn_ovia ptap \
...
selectNetsByNumber power_list_nums metal7_conn p_rmetal7_conn np_rmetal7_conn
...
mergevia -V -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx -cnt \
...
mergevia -V -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx -cnt \
	np_rVia6 rVia6 - np_rmetal7_conn np_rmetal6_conn
mergevia -V -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx -cnt \
...
connect -V -relocate NET np_rMetal1_p:np_rMetal1_p.conn \
	...
	rVia6 rcont_poly rvia2_out_capInd _nmos_12_MOS_1_mgvia \
	_pmos_12_MOS_7_mgvia - ntap_ndiff_conn_ovia,6,4 \
...
mergevia -V -i -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx -cnt \
...
rex -V -m -pd -I'#' -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx \
	...
	np_rmetal6_conn::mt6_cut np_rmetal7_conn::mt7_cut - rMetal1_v,2 \
	rVia1,2,3,t rVia3,4,5,t rVia4,5,6,t rVia5,6,7,t rVia6,7,8,t \
	rcont_ndiff,2,t rcont_pdiff,2,t rcont_poly,1,2,t \
	rvia2_out_capInd,3,4,t _nmos_12_MOS_1_mgvia,1,z \
...
stamp -V -i2 np_rmetal7_conn rVia6 np_rVia6
...
geom -V -i p_rmetal7_conn,np_rmetal7_conn - so_mt7,1,n
geom -V p_rmetal7_conn,np_rmetal7_conn - mt7,1,i,1
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,np_rmetal5_conn.res,np_rmetal6_conn.res,np_rmetal7_conn.res,mwires.res,rVia6.res,rVia5.res,rVia4.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-M_perim_off -c \
	/opt/cadence-designkits/gpdk090_v3.9/assura/rcx/qrcTechFile -f sti \
	diff poly:poly_cut mt1:mt1_cut mt2:mt2_cut mt3:mt3_cut mt4:mt4_cut \
	mt5:mt5_cut mt6:mt6_cut mt7:mt7_cut mt8 mt9 allGate - \
	/opt/cadence-designkits/gpdk090_v3.9/assura/rcx/qrcTechFile - - NET - \
	capfile
...
xreduce -V -mergecap -n NET -tech \
	/opt/cadence-designkits/gpdk090_v3.9/assura/rcx -d1 -e \
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti,np_rndiff_conn,np_rpdiff_conn,np_rnwell_conn,np_rpsubstrate,rVia1,rVia3,rVia4,rVia5,rVia6,rcont_poly,rvia2_out_capInd \
	-mfactorR infinite -sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 \
	-rPvia \
	rVia6.res,rVia5.res,rVia4.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,np_rmetal5_conn.res,np_rmetal6_conn.res,np_rmetal7_conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	np_rmetal7_conn.res,Rnp_rmetal7_conn.dev2 \
	...
	np_rpoly_conn.res,Rnp_rpoly_conn.dev2 rVia6.res,RrVia6.dev2 \
...
geom mt7 np_rmetal7_conn - np_rmetal7_conn,11,i,1
...
stamp -i2 np_rmetal7_conn rVia6 np_rVia6
...
metal7_conn np_rmetal7_conn p_rmetal7_conn
