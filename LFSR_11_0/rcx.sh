#!/bin/ksh
# This script was generated Mon May 17 03:35:37 2021 by:
#
...
#	/home/hpl23/ECE4740-Final-Project/LFSR_11_0.xcn -assura_run_dir \
#	/home/hpl23/ECE4740-Final-Project -assura_run_name LFSR_11_0 -rcxdir \
#	/home/hpl23/ECE4740-Final-Project/LFSR_11_0 -xy_coordinates c,r -type \
#	full -temperature 25.0 -tempdir \
#	/home/hpl23/ECE4740-Final-Project/LFSR_11_0/rcx_temp -sub_node_char # \
...
#	/home/hpl23/ECE4740-Final-Project/LFSR_11_0/extview.tmp \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/hpl23/ECE4740-Final-Project/LFSR_11_0/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/hpl23/ECE4740-Final-Project/LFSR_11_0
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/hpl23/ECE4740-Final-Project/LFSR_11_0/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/hpl23/ECE4740-Final-Project/LFSR_11_0/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/hpl23/ECE4740-Final-Project/LFSR_11_0
...
/home/hpl23/ECE4740-Final-Project/LFSR_11_0.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/hpl23/ECE4740-Final-Project LFSR_11_0 -unit meters -mFactorR \
	-- -V1 -H satfile -r /home/hpl23/ECE4740-Final-Project/LFSR_11_0.xcn \
	-df2 -xgl
...
flattenLayers -m metal5_conn metal4_conn metal3_conn metal2_conn metal1_conn \
	poly_conn ndiff_conn pdiff_conn nwell_conn psubstrate Via4 Via3 \
	via2_out_capInd Via1 Metal1_v Metal1_p cont_poly cont_pdiff \
...
connect -V -relocate NET np_rMetal1_p:np_rMetal1_p.conn \
	...
	np_rntap:np_rntap.conn np_rptap:np_rptap.conn rVia1 rVia3 rVia4 \
...
rex -V -m -pd -I'#' -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx \
	...
	np_rmetal4_conn::mt4_cut np_rmetal5_conn::mt5_cut - rMetal1_v,2 \
	rVia1,2,3,t rVia3,4,5,t rVia4,5,6,t rcont_ndiff,2,t rcont_pdiff,2,t \
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,np_rmetal5_conn.res,mwires.res,rVia4.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-M_perim_off -c \
	...
	mt5:mt5_cut mt6 mt7 mt8 mt9 allGate - \
...
xreduce -V -mergecap -n NET -tech \
	...
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti,np_rndiff_conn,np_rpdiff_conn,np_rnwell_conn,np_rpsubstrate,rVia1,rVia3,rVia4,rcont_poly,rvia2_out_capInd \
	-mfactorR infinite -sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 \
	-rPvia \
	rVia4.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,np_rmetal5_conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	np_rpoly_conn.res,Rnp_rpoly_conn.dev2 rVia4.res,RrVia4.dev2 \
	rVia3.res,RrVia3.dev2 rvia2_out_capInd.res,Rrvia2_out_capInd.dev2 \
	rVia1.res,RrVia1.dev2 rcont_poly.res,Rrcont_poly.dev2 \
