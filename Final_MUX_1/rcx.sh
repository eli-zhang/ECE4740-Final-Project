#!/bin/ksh
# This script was generated Mon May 10 13:01:16 2021 by:
#
...
#	/home/hpl23/ECE4740-Final-Project/Final_MUX_1.xcn -assura_run_dir \
#	/home/hpl23/ECE4740-Final-Project -assura_run_name Final_MUX_1 \
#	-rcxdir /home/hpl23/ECE4740-Final-Project/Final_MUX_1 -xy_coordinates \
#	c,r -type full -temperature 25.0 -tempdir \
#	/home/hpl23/ECE4740-Final-Project/Final_MUX_1/rcx_temp -sub_node_char \
...
#	-output /home/hpl23/ECE4740-Final-Project/Final_MUX_1/extview.tmp \
...
##RC_FREQUENCY=
##RCXDIR=/home/hpl23/ECE4740-Final-Project/Final_MUX_1
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/hpl23/ECE4740-Final-Project/Final_MUX_1/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/hpl23/ECE4740-Final-Project/Final_MUX_1/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/hpl23/ECE4740-Final-Project/Final_MUX_1
...
/home/hpl23/ECE4740-Final-Project/Final_MUX_1.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/hpl23/ECE4740-Final-Project Final_MUX_1 -unit meters -mFactorR \
	-- -V1 -H satfile -r \
	/home/hpl23/ECE4740-Final-Project/Final_MUX_1.xcn -df2 -xgl
...
flattenLayers -m metal4_conn metal3_conn metal2_conn metal1_conn poly_conn \
	ndiff_conn pdiff_conn nwell_conn psubstrate Via3 via2_out_capInd Via1 \
	Metal1_v Metal1_p cont_poly cont_pdiff cont_ndiff \
...
connect -V -relocate NET np_rMetal1_p:np_rMetal1_p.conn \
	...
	np_rntap:np_rntap.conn np_rptap:np_rptap.conn rVia1 rVia3 rcont_poly \
...
rex -V -m -pd -I'#' -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx \
	...
	np_rmetal4_conn::mt4_cut - rMetal1_v,2 rVia1,2,3,t rVia3,4,5,t \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt6 -b \
	mt3,mt2,mt1,poly,diff,sti -t mt7,mt8,mt9 -Maxw 2.1 -p \
	mt4:mt4_cut,key,mt6,key 0,2.1,0 - mt4_mt6.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b mt3,mt2,mt1,poly,diff,sti -t \
	mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt4:mt4_cut,key,mt5,key 0,2.1,0 - \
	mt4_mt5.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R mt5 -b mt2,mt1,poly,diff,sti \
	-t mt6,mt7,mt8,mt9 -k mt4:0.36 -Maxw 2.1 -p mt3:mt3_cut,key,mt5,key \
	0,2.1,0 - mt3_mt5.sip
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,mwires.res,rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-M_perim_off -c \
...
xreduce -V -mergecap -n NET -tech \
	...
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti,np_rndiff_conn,np_rpdiff_conn,np_rnwell_conn,np_rpsubstrate,rVia1,rVia3,rcont_poly,rvia2_out_capInd \
	-mfactorR infinite -sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 \
	-rPvia \
	rVia3.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,np_rmetal4_conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	np_rpoly_conn.res,Rnp_rpoly_conn.dev2 rVia3.res,RrVia3.dev2 \
	...
	/home/hpl23/ECE4740-Final-Project/Final_MUX_1/extview.tmp
