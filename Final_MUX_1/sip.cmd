...
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt6 -b 	mt3,mt2,mt1,poly,diff,sti -t mt7,mt8,mt9 -Maxw 2.1 -p 	mt4:mt4_cut,key,mt6,key 0,2.1,0 - mt4_mt6.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt3,mt2,mt1,poly,diff,sti -t 	mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt4:mt4_cut,key,mt5,key 0,2.1,0 - 	mt4_mt5.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt5 -b mt2,mt1,poly,diff,sti 	-t mt6,mt7,mt8,mt9 -k mt4:0.36 -Maxw 2.1 -p mt3:mt3_cut,key,mt5,key 	0,2.1,0 - mt3_mt5.sip
