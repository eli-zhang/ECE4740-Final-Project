#!/bin/ksh
# This script was generated Wed May  5 21:28:34 2021 by:
#
...
#	/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset.xcn \
#	-assura_run_dir /home/hpl23/ECE4740-Final-Project -assura_run_name \
#	dff_dynamic_reset -rcxdir \
#	/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset -xy_coordinates \
#	c,r -type full -temperature 25.0 -tempdir \
#	/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset/rcx_temp \
...
#	/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset/extview.tmp \
...
##ASSURA_RUN_NAME=dff_dynamic_reset
...
##NETS_FILE=/dev/null
##OUTPUT=/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/hpl23/ECE4740-Final-Project/dff_dynamic_reset/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/hpl23/ECE4740-Final-Project/dff_dynamic_reset
...
export GOALIE2DIR
vdbToRcx /home/hpl23/ECE4740-Final-Project dff_dynamic_reset -unit meters \
	-mFactorR -- -V1 -H satfile -r \
	/home/hpl23/ECE4740-Final-Project/dff_dynamic_reset.xcn -df2 -xgl
...
flattenLayers -m metal3_conn metal2_conn metal1_conn poly_conn ndiff_conn \
	pdiff_conn nwell_conn psubstrate via2_out_capInd Via1 Metal1_v \
	Metal1_p cont_poly cont_pdiff cont_ndiff ptap_pdiff_conn_ovia ptap \
...
rex -V -m -pd -I'#' -tech /opt/cadence-designkits/gpdk090_v3.9/assura/rcx \
	...
	rVia1,2,3,t rcont_ndiff,2,t rcont_pdiff,2,t rcont_poly,1,2,t \
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,mwires.res,rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-M_perim_off -c \
	/opt/cadence-designkits/gpdk090_v3.9/assura/rcx/qrcTechFile -f sti \
	diff poly:poly_cut mt1:mt1_cut mt2:mt2_cut mt3:mt3_cut mt4 mt5 mt6 \
	mt7 mt8 mt9 allGate - \
...
xreduce -V -mergecap -n NET -tech \
	...
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti,np_rndiff_conn,np_rpdiff_conn,np_rnwell_conn,np_rpsubstrate,rVia1,rcont_poly,rvia2_out_capInd \
	-mfactorR infinite -sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 \
	-rPvia \
	rvia2_out_capInd.res,rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res \
	-rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,np_rmetal3_conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	np_rpoly_conn.res,Rnp_rpoly_conn.dev2 \
